...
mod m20240321_123731_template_history;
mod m20240321_123743_template_downloads;
mod m20240321_123757_comments;
mod m20240321_123823_comment_likes;
mod m20240321_123836_comment_dislikes;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20240321_123731_template_history::Migration),
            Box::new(m20240321_123743_template_downloads::Migration),
            Box::new(m20240321_123757_comments::Migration),
            Box::new(m20240321_123823_comment_likes::Migration),
            Box::new(m20240321_123836_comment_dislikes::Migration),
